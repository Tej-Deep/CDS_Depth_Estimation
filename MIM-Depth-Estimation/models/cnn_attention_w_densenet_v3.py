...
class MultiHeadA(nn.Module):
    def __init__(self, out_c):
        ...
        self.attention = torch.nn.MultiheadAttention(out_c, max(out_c//128, 1))
...
class Enc_Dec_Model(nn.Module):
    def __init__(self):
        ...
        self.encoder4 = Encoder_Block(128, 256)
        self.encoder5 = Encoder_Block(256, 512)
...
class CNN_ATTN_w_Densenet(nn.Module):
...
if __name__ == "__main__":
    model = CNN_ATTN_w_Densenet(max_depth=10).cuda()
    print(model)
